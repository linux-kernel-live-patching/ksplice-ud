...
/* 1 byte opcode */
ud_opcmap_entry_t insntbl_1byte[0x100] = {
...
/* 05 */ { Iadd,	rAX,	Iz,	NOARG,	 Po32 | REX(_W) },
/* 06 */ { Ipush,	ES,	NOARG,	NOARG,	Pnone },
/* 07 */ { Ipop,	ES,	NOARG,	NOARG,	Pnone },
/* 08 */ { Ior,		Eb,	Gb,	NOARG,	 Pa32 | REX(_X|_B) },
/* 09 */ { Ior,		Ev,	Gv,	NOARG,	 Pa32 | Po32 | REX(_W|_R|_X|_B) },
/* 0A */ { Ior,		Gb,	Eb,	NOARG,	 Pa32 | REX(_X|_B)},
/* 0B */ { Ior,		Gv,	Ev,	NOARG,	 Pa32 | Po32 | REX(_W|_R|_X|_B) },
/* 0C */ { Ior,		AL,	Ib,	NOARG,	Pnone },
/* 0D */ { Ior,		rAX,	Iz,	NOARG,	 Po32 | REX(_W) },
...
/* 15 */ { Iadc,	rAX,	Iz,	NOARG,	 Po32 | REX(_W) },
/* 16 */ { Ipush,	SS,	NOARG,	NOARG,	Pnone | Pinv64 },
/* 17 */ { Ipop,	SS,	NOARG,	NOARG,	Pnone | Pinv64 },
...
/* 1D */ { Isbb,	rAX,	Iz,	NOARG,	Po32 | REX(_W) },
/* 1E */ { Ipush,	DS,	NOARG,	NOARG,	Pnone| Pinv64 },
/* 1F */ { Ipop,	DS,	NOARG,	NOARG,	Pnone| Pinv64 },
...
/* 25 */ { Iand,	rAX,	Iz,	NOARG,	Po32 | REX(_W) },
...
/* 2D */ { Isub,	rAX,	Iz,	NOARG,	Po32 | REX(_W) },
/* 2E */ { Ics,		CS,	NOARG,	NOARG,	Pnone },
/* 2F */ { Idas,	NOARG,	NOARG,	NOARG,	Po32 | REX(_W) },
...
/* 35 */ { Ixor,	rAX,	Iz,	NOARG,	 Po32 | REX(_W) },
/* 36 */ { Iss,		ES,	NOARG,	NOARG,	Pinv64 },
/* 37 */ { Iaaa,	NOARG,	NOARG,	NOARG,	Pinv64 },
...
/* 3D */ { Icmp,	rAX,	Iz,	NOARG,	Po32 | REX(_W) },
/* 3E */ { Ids,		ES,	NOARG,	NOARG,	Pnone },
/* 3F */ { Iaas,	NOARG,	NOARG,	NOARG,	Pinv64 },
...
/* 68 */ { Ipush,	Iz,	NOARG,	NOARG,	Po32 | Pcast },
/* 69 */ { Iimul,	Gv,	Ev,	Iz,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
...
/* 8D */ { Ilea,	Gv,	E,	NOARG,	Po32 |Pa32 | REX(_R|_X|_B) },
/* 8E */ { Imov,	S,	Ev,	NOARG,	Po32 |Pa32 | REX(_R|_X|_B) },
/* 8F */ { Ipop,	Ev,	NOARG,	NOARG,	Po32 |Pa32 | REX(_W|_R|_X|_B) },
...
/* 9A */ { Icall,	Ap,	NOARG,	NOARG,	Pcast | Pa32 | Pinv64 },
...
/* A5 */ { Imovs,	NOARG,	NOARG,	NOARG,	Po32 | Psuff | REX(_W) },
/* A6 */ { Icmpsb,	NOARG,	NOARG,	NOARG,	Pnone },
/* A7 */ { Icmps,	NOARG,	NOARG,	NOARG,	Po32 | Psuff | REX(_W) },
/* A8 */ { Itest,	AL,	Ib,	NOARG,	Pnone },
/* A9 */ { Itest,	rAX,	Iz,	NOARG,	Po32 | REX(_W) },
/* AA */ { Istosb,	NOARG,	NOARG,	NOARG,	Pnone },
/* AB */ { Istos,	NOARG,	NOARG,	NOARG,	Psuff | REX(_W) },
/* AC */ { Ilodsb,	NOARG,	NOARG,	NOARG,	Pnone },
/* AD */ { Ilods,	NOARG,	NOARG,	NOARG,	Po32 | Psuff | REX(_W) },
/* AE */ { Iscasb,	NOARG,	NOARG,	NOARG,	Pnone },
/* AF */ { Iscas,	NOARG,	NOARG,	NOARG,	Po32 | Psuff | REX(_W) },
...
/* B8 */ { Imov,	rAXr8,	Iz,	NOARG,	Po32 | REX(_W|_B) },
/* B9 */ { Imov,	rCXr9,	Iz,	NOARG,	Po32 | REX(_W|_B) },
/* BA */ { Imov,	rDXr10,	Iz,	NOARG,	Po32 | REX(_W|_B) },
/* BB */ { Imov,	rBXr11,	Iz,	NOARG,	Po32 | REX(_W|_B) },
/* BC */ { Imov,	rSPr12,	Iz,	NOARG,	Po32 | REX(_W|_B) },
/* BD */ { Imov,	rBPr13,	Iz,	NOARG,	Po32 | REX(_W|_B) },
/* BE */ { Imov,	rSIr14,	Iz,	NOARG,	Po32 | REX(_W|_B) },
/* BF */ { Imov,	rDIr15,	Iz,	NOARG,	Po32 | REX(_W|_B) },
...
/* E8 */ { Icall,	Jz,	NOARG,	NOARG,	Po32 | Pcast },
/* E9 */ { Ijmp,	Jz,	NOARG,	NOARG,	Po32  },
 ...
 */
ud_opcmap_entry_t insntbl_2byte[0x100] = {
...
ud_opcmap_entry_t insntbl_2byte_prefixF3[0x100] = {
...
ud_opcmap_entry_t insntbl_2byte_prefix66[0x100] = {
/* 00 */ { Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
/* 01 */ { Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
/* 02 */ { Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
/* 03 */ { Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
ud_opcmap_entry_t insntbl_2byte_prefixF2[0x100] = {
/* 00 */ { Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
/* 01 */ { Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
/* 02 */ { Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
/* 03 */ { Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
ud_opcmap_entry_t insntbl_group1_op80[0x8] = {
...
ud_opcmap_entry_t insntbl_group1_op81[0x8] = {
	{ Iadd,		Ev,	Iz,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Ior,		Ev,	Iz,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Iadc,		Ev,	Iz,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Isbb,		Ev,	Iz,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Iand,		Ev,	Iz,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Isub,		Ev,	Iz,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Ixor,		Ev,	Iz,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Icmp,		Ev,	Iz,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) }
};

ud_opcmap_entry_t insntbl_group1_op82[0x8] = {
...
ud_opcmap_entry_t insntbl_group1A_op8F[0x8] = {
...
ud_opcmap_entry_t insntbl_group1_op83[0x8] = {
...
ud_opcmap_entry_t insntbl_group2_opC0[0x8] = {
...
ud_opcmap_entry_t insntbl_group2_opC1[0x8] = {
...
ud_opcmap_entry_t insntbl_group2_opD0[0x8] = {
...
ud_opcmap_entry_t insntbl_group2_opD1[0x8] = {
	...
	{ Iinvalid,	Ev,	I1,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Isar,		Ev,	I1,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) }
};

ud_opcmap_entry_t insntbl_group2_opD2[0x8] = {
...
ud_opcmap_entry_t insntbl_group2_opD3[0x8] = {
...
ud_opcmap_entry_t insntbl_group3_opF6[0x8] = {
...
ud_opcmap_entry_t insntbl_group3_opF7[0x8] = {
...
ud_opcmap_entry_t insntbl_group4_opFE[0x8] = {
...
ud_opcmap_entry_t insntbl_group5_opFF[0x8] = {
	{ Iinc,		Evw,	NOARG,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Idec,		Evw,	NOARG,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Icall,	Evw,	NOARG,	NOARG,	Pcast| Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Icall,	Ep,	NOARG,	NOARG,	Pcast| Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Ijmp,		Evw,	NOARG,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Ijmp,		Ep,	NOARG,	NOARG,	Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Ipush,	Evw,	NOARG,	NOARG,	Pcast| Po32 | Pa32 | REX(_W|_R|_X|_B) },
	{ Iinvalid,	NOARG, 	NOARG,	NOARG,	Pnone }
};

/* group 6 */
ud_opcmap_entry_t insntbl_group6_op0F00[0x8] = {
...
/* group 7  */
ud_opcmap_entry_t insntbl_group7_op0F01[0x8] = {
...
/* group 8  */
ud_opcmap_entry_t insntbl_group8_op0FBA[0x8] = {
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
/* group 9  */
ud_opcmap_entry_t insntbl_group9_op0FC7[0x8] = {
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
/* group A  */
ud_opcmap_entry_t insntbl_groupA_op0FB9[0x8] = {
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
/* group B  */
ud_opcmap_entry_t insntbl_groupB_opC6[0x8] = {
...
/* group B  */
ud_opcmap_entry_t insntbl_groupB_opC7[0x8] = {
...
/* group C  */
ud_opcmap_entry_t insntbl_groupC_op0F71[0x8] = {
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
/* group C  */
ud_opcmap_entry_t insntbl_groupC_op0F71_prefix66[0x8] = {
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
/* group D  */
ud_opcmap_entry_t insntbl_groupD_op0F72[0x8] = {
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
ud_opcmap_entry_t insntbl_groupD_op0F72_prefix66[0x8] = {
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
/* group E  */
ud_opcmap_entry_t insntbl_groupE_op0F73[0x8] = {
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
/* group F  */
ud_opcmap_entry_t insntbl_groupF_op0FAE[0x8] = {
...
ud_opcmap_entry_t insntbl_groupE_op0F73_prefix66[0x8] = {
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
/* D8 Opcode Map */
ud_opcmap_entry_t insntbl_x87_opD8[0x8*0x8] = {
...
/* D9 Opcode Map */
ud_opcmap_entry_t insntbl_x87_opD9[0x8*0x8] = {
...
/* DA Opcode Map */
ud_opcmap_entry_t insntbl_x87_opDA[0x8*0x8] = {
...
/* DB Opcode Map */
ud_opcmap_entry_t insntbl_x87_opDB[0x8*0x8] = {
...
/* DC Opcode Map */
ud_opcmap_entry_t insntbl_x87_opDC[0x8*0x8] = {
	{ Ifadd,	ST0,	ST0,	NOARG,	Pnone },
...
/* DD Opcode Map */
ud_opcmap_entry_t insntbl_x87_opDD[0x8*0x8] = {
...
/* DE Opcode Map */
ud_opcmap_entry_t insntbl_x87_opDE[0x8*0x8] = {
...
/* DF Opcode Map */
ud_opcmap_entry_t insntbl_x87_opDF[0x8*0x8] = {
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
	{ Iinvalid,	NOARG,	NOARG,	NOARG,	Pnone },
...
ud_opcmap_entry_t insntbl_3DNow =
	{ I3dnow,	P,	Q,	NOARG  };

/* 3D Now instructions with suffix */
extern uint32_t ud_get_3dnow_insn_mnemonic(uint8_t suffix)
{
  switch(suffix) {
...
ud_opcmap_entry_t *insntbl_x87_reg[] = {
	insntbl_x87_opD8reg,
	insntbl_x87_opD9reg,
	insntbl_x87_opDAreg,
	insntbl_x87_opDBreg,
...
ud_opcmap_entry_t nop = { Inop,	NOARG,	NOARG,	NOARG,	Pnone };

static void search_1byte_insn(register ud_t *ud)
{
	ud->opcmap_entry = &insntbl_1byte[src_curr(ud)];

	if (src_curr(ud) == 0x90 && ud->dis_mode == MODE32)
			ud->opcmap_entry = &nop;	
	/* check if the opcode points to a group */
	else if ((ud->opcmap_entry)->mnemonic == Igrp) {
		switch(src_curr(ud)) {
			/* group 1 */
			case 0x80:
				ud->opcmap_entry = &insntbl_group1_op80[MODRM_REG(src_peek(ud))];
				break;
			case 0x81:
				ud->opcmap_entry = &insntbl_group1_op81[MODRM_REG(src_peek(ud))];
				break;
			case 0x82:
				ud->opcmap_entry = &insntbl_group1_op82[MODRM_REG(src_peek(ud))];
				break;
			case 0x83:
				ud->opcmap_entry = &insntbl_group1_op83[MODRM_REG(src_peek(ud))];
				break;
			case 0x8F:
				ud->opcmap_entry = &insntbl_group1A_op8F[MODRM_REG(src_peek(ud))];
				break;
			/* group 2 */
			case 0xC0:
				ud->opcmap_entry = &insntbl_group2_opC0[MODRM_REG(src_peek(ud))];
				break;
			case 0xC1:
				ud->opcmap_entry = &insntbl_group2_opC1[MODRM_REG(src_peek(ud))];
				break;
			/* group 11 */
			case 0xC6:
				ud->opcmap_entry = &insntbl_groupB_opC6[MODRM_REG(src_peek(ud))];
				break;
			case 0xC7:
				ud->opcmap_entry = &insntbl_groupB_opC7[MODRM_REG(src_peek(ud))];
				break;
			case 0xD0:
				ud->opcmap_entry = &insntbl_group2_opD0[MODRM_REG(src_peek(ud))];
				break;
			case 0xD1:
				ud->opcmap_entry = &insntbl_group2_opD1[MODRM_REG(src_peek(ud))];
				break;
			case 0xD2:
				ud->opcmap_entry = &insntbl_group2_opD2[MODRM_REG(src_peek(ud))];
				break;
			case 0xD3:
				ud->opcmap_entry = &insntbl_group2_opD3[MODRM_REG(src_peek(ud))];
				break;
			/* group 3 */
			case 0xF6:
				ud->opcmap_entry = &insntbl_group3_opF6[MODRM_REG(src_peek(ud))];
				break;
			case 0xF7:
				ud->opcmap_entry = &insntbl_group3_opF7[MODRM_REG(src_peek(ud))];
				break;
			/* group 4 */
			case 0xFE:
				ud->opcmap_entry = &insntbl_group4_opFE[MODRM_REG(src_peek(ud))];
				break;
			/* group 5 */
			case 0xFF:
				ud->opcmap_entry = &insntbl_group5_opFF[MODRM_REG(src_peek(ud))];
				break;
		}
	}
	else
	...
	if ((ud->opcmap_entry)->mnemonic == Ix87) {
		 ...
		 */
		if (src_peek(ud) <= 0xBF)
			ud->opcmap_entry = &insntbl_x87_reg[(src_curr(ud))-0xD8][MODRM_REG(src_peek(ud))];
		else {
			ud->opcmap_entry = &insntbl_x87[src_curr(ud)-0xD8][src_peek(ud)-0xC0];
			src_next(ud);
		}
	}  
}

static void search_2byte_insn(register ud_t *ud)
{
	/* move to next byte */
	src_next(ud);

	/* check for prefix 0x66 */
	if (ud->prefix.opr) {
		/* get table entry */
		ud->opcmap_entry = &insntbl_2byte_prefix66[src_curr(ud)];
		if ((ud->opcmap_entry)->mnemonic != Iinvalid)
			ud->prefix.opr = 0;
		else	ud->opcmap_entry = NULL;
	}

	/* check for prefix 0xF3 */
	if (ud->opcmap_entry == NULL && ud->prefix.rep) {
		/* get table entry */
		ud->opcmap_entry = &insntbl_2byte_prefixF3[src_curr(ud)];
		if ((ud->opcmap_entry)->mnemonic != Iinvalid)
			ud->prefix.rep = 0;
		else	ud->opcmap_entry = NULL;
	}

	/* check for prefix 0xF2 */
	if (ud->opcmap_entry == NULL && ud->prefix.repne) {
		/* get table entry */
		ud->opcmap_entry = &insntbl_2byte_prefixF2[src_curr(ud)];
		if ((ud->opcmap_entry)->mnemonic != Iinvalid)
			ud->prefix.repne = 0;
		else	ud->opcmap_entry = NULL;
	}
	...
	if (ud->opcmap_entry == NULL)	
		/* get table entry */
		ud->opcmap_entry = &insntbl_2byte[src_curr(ud)];

	/* check if the opcode points to the 3dnow group */
	/* RETURNS */
	if ((ud->opcmap_entry)->mnemonic == I3dnow) {
		ud->opcmap_entry = &insntbl_3DNow;
		return;
	} 
	...
	switch (src_curr(ud)) {
		/* group 6 */
		case 0x00:
			ud->opcmap_entry = &insntbl_group6_op0F00[MODRM_REG(src_peek(ud))];
			break;
		/* group 7 */
		case 0x01:
			ud->opcmap_entry = &insntbl_group7_op0F01[MODRM_REG(src_peek(ud))];
			break;
		/* group 8 */
		case 0xBA:
			ud->opcmap_entry = &insntbl_group8_op0FBA[MODRM_REG(src_peek(ud))];
			break;
		/* group 9 */
		case 0xC7:
			ud->opcmap_entry = &insntbl_group9_op0FC7[MODRM_REG(src_peek(ud))];
			break;
		/* group A */
		case 0xB9:
			ud->opcmap_entry = &insntbl_groupA_op0FB9[MODRM_REG(src_peek(ud))];
			break;
		/* group C */
		case 0x71:
			if (ud->prefix.opr) {
				ud->opcmap_entry = &insntbl_groupC_op0F71_prefix66[MODRM_REG(src_peek(ud))];
				ud->prefix.opr = 0;
			} else	ud->opcmap_entry = &insntbl_groupC_op0F71[MODRM_REG(src_peek(ud))];
			break;
		/* group D */
		case 0x72:
			if (ud->prefix.opr) {
				ud->opcmap_entry = &insntbl_groupD_op0F72_prefix66[MODRM_REG(src_peek(ud))];
				ud->prefix.opr = 0;
			} else	ud->opcmap_entry = &insntbl_groupD_op0F72[MODRM_REG(src_peek(ud))];
			break;
		/* group E */
		case 0x73:
			if (ud->prefix.opr) {
				ud->opcmap_entry = &insntbl_groupE_op0F73_prefix66[MODRM_REG(src_peek(ud))];
				ud->prefix.opr = 0;
			} else	ud->opcmap_entry = &insntbl_groupE_op0F73[MODRM_REG(src_peek(ud))];
			break;
		/* group F */
		case 0xAE:
			ud->opcmap_entry = &insntbl_groupF_op0FAE[MODRM_REG(src_peek(ud))];
			break;
		/* Error */
		default:
			ud->error = 1;
...
/* ud_search_opcmap() - Searches the x86 opcode table for the instruction corresponding
 * to the opcode given by next byte in the byte stream.
 */
extern void ud_search_opcmap(register ud_t *ud) 
{
	/* load byte from stream */	
	src_next(ud);

	/* set map entry to null */
	ud->opcmap_entry = NULL;

	/* check for two byte opcodes (0x0F) */
	if (0x0F == src_curr(ud))
		search_2byte_insn(ud);
	else	search_1byte_insn(ud);
}
